...
export function LeftSidebar({ activeYear, onYearChange }: LeftSidebarProps) {
  ...
  // We store the raw slider value; invert for display
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto sidebar-scroll">
        ...
        <div className="px-3 pt-4 pb-2">
          ...
          <ul className="flex flex-col gap-1">
            {LAYERS.map(layer => (
              <li key={layer.id}>
                {collapsed ? (
                  /* Collapsed: just the emoji icon, centred */
                  <button
        ...
        <div className="px-3 pt-4 pb-6 border-t border-white/5">
          ...
          {collapsed ? (
            /* Collapsed: just the year rotated vertically */
              ...
              <div className="flex items-center gap-3 w-full justify-center">
                ...
                <div className="relative h-[160px] flex items-center justify-center">
                  <input
                    ...
                    value={sliderVal}
                    onChange={e => {
                      // Invert: slider bottom=2016, top=2026
